...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="img/Kementerian_Agama_new_logo.png">
        <title>SIGWakaf - Peta Wakaf</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Peta Wakaf</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Peta Wakaf</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fa fa-map mr-1"></i>
                               Peta Persebaran Tanah Wakaf Kecamatan X
                            </div>
                        </div>
                        <img src="img/peta laweyan_surakarta.png" align="center" width="1000px" height="600px">
                    </div>
                </main>
                <br>
